...
public class ManageFormTeac extends JFrame {
    ...
    private final JButton button_mod;
     ...
     * Create the frame
     */
    public ManageFormTeac(String teacher) {
        super();
        getContentPane().setLayout(null);
        setTitle("学生信息管理-老师 欢迎您"+teacher+"老师！");
        ...
        button_2.addActionListener(new ActionListener() {
            public void actionPerformed(final ActionEvent e) {
                ...
                if (sid == null || sid.trim().equals("")) {
                    JOptionPane.showMessageDialog(ManageFormTeac.this, "请输入学号！");
                    return;
                }
                Student student = dao.queryStudentById(sid);
                if (student == null) {
                    JOptionPane.showMessageDialog(ManageFormTeac.this, "查无此人！！");
                    return;
                }
                //数据存在 显示到界面
        ...
        button_mod.addActionListener(new ActionListener() {
            public void actionPerformed(final ActionEvent e) {
                ...
                if (is) {
                    JOptionPane.showMessageDialog(ManageFormTeac.this, "修改成功！");
                } else {
                    JOptionPane.showMessageDialog(ManageFormTeac.this, "修改失败！");
                }
            }
        });
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(final ActionEvent e) {
                ...
                int flag = JOptionPane.showConfirmDialog(ManageFormTeac.this, "您确定删除此学员信息么？");
                ...
                String sid = uidTextField.getText();
                if (sid == null || sid.trim().equals("")) {
                    JOptionPane.showMessageDialog(ManageFormTeac.this, "请输入学员编号！");
                    return;
                }

                boolean is = dao.delStudent(sid);
                if (is) {
                    ...
                    JOptionPane.showMessageDialog(ManageFormTeac.this, "删除成功！");
                } else {
                    JOptionPane.showMessageDialog(ManageFormTeac.this, "删除失败！");
                }
            }
        });
        button.setText("删除");
        ...
        button_3.addActionListener(new ActionListener() {
            public void actionPerformed(final ActionEvent e) {
                int sel = JOptionPane.showConfirmDialog(ManageFormTeac.this, "您确定退出系统么？");
        ...
        button_5.addActionListener(new ActionListener() {
            public void actionPerformed(final ActionEvent e) {
                new CurriFormTeac().setVisible(true);
            }
        });
        button_5.setText("学生成绩查询");
