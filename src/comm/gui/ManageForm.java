...
public class ManageForm extends JFrame {
    ...
    private JTextField uClassTextField;
    ...
    public ManageForm() {
        ...
        button_2.addActionListener(new ActionListener() {
            public void actionPerformed(final ActionEvent e) {
                ...
                if (sid == null || sid.trim().equals("")) {
                    JOptionPane.showMessageDialog(ManageForm.this, "请输入学号！");
                ...
                if (student == null) {
                    JOptionPane.showMessageDialog(ManageForm.this, "查无此人！！");
                    return;
                }
                //数据存在 显示到界面
                ...
                uClassTextField.setText(student.getStuClass());
        ...
        button_mod.addActionListener(new ActionListener() {
            public void actionPerformed(final ActionEvent e) {
                ...
                student.setStuClass(uClassTextField.getText());
                ...
                if (is) {
                    JOptionPane.showMessageDialog(ManageForm.this, "修改成功！");
                } else {
                    JOptionPane.showMessageDialog(ManageForm.this, "修改失败！");
                }
            }
        });
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(final ActionEvent e) {
                ...
                if (is) {
                    ...
                    JOptionPane.showMessageDialog(ManageForm.this, "删除成功！");
                } else {
                    JOptionPane.showMessageDialog(ManageForm.this, "删除失败！");
                }
            }
        });
        button.setText("删除");
        ...
        button_3.addActionListener(new ActionListener() {
            public void actionPerformed(final ActionEvent e) {
                int sel = JOptionPane.showConfirmDialog(ManageForm.this, "您确定退出系统么？");
